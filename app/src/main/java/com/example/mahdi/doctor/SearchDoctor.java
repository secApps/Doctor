...
public class SearchDoctor extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitle = getTitle();
       Button searchDoc=(Button)findViewById(R.id.button3);
        searchDoc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(SearchDoctor.this,ImagesActivity.class);
                startActivity(in);
            }
        });
        // Set up the drawer.
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onAttach(Activity activity) {
            ...
            ((SearchDoctor) activity).onSectionAttached(
